...
let BonsaiService = exports.BonsaiService = class BonsaiService {
    constructor(bonsaiRepository) {
        this.bonsaiRepository = bonsaiRepository;
    }
    async getAll() {
        return this.bonsaiRepository.find();
    }
    async createBonsai(bonsaiDetails) {
...
exports.BonsaiService = BonsaiService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(index_js_1.Bonsai)),
